...
if(typeof $.fn.rte === "undefined") {
    ...
    $.fn.rte = function(options) {
		...
		if (options && typeof(options) == 'object') {
 		...
 		}else if (options == 'updateTa') {
			return this.each(function() {
				//disableDesignMode(false);
				var content = $(this).next().contents().find("body").html();
				$(this).val(content);
    ...
    return this.each( function() {
        ...
        function toolbar() {
            var tb = $("<div class='rte-toolbar' id='toolbar-"+ element_id +"'><div>\
                <p>\
                    <select>\
                        <option value=''>Free Flowing</option>\
                ...
                <p>\
                    ...
                    <a href='#' class='link'><img width='16' height='16' src='"+opts.media_url+"web.png' alt='Link' /></a>&nbsp;&nbsp;&nbsp;\
                    <a href='#' class='disable'><img width='16' height='16' src='"+opts.media_url+"edit.png' alt='Source Mode' /></a>\
                </p></div></div>");
